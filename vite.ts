...
export default defineConfig(() => {
  ...
  return {
    ...
    build: {
      // Warn only for genuinely oversized chunks after vendor splitting.
      ...
      rollupOptions: {
        output: {
          manualChunks(id) {
            ...
            // Keep the PDF and chart stacks isolated from the initial React
            // runtime. React and d3 stay in the shared runtime chunk because
            // both have cross-package helpers; forcing them into separate
            // manual chunks creates circular imports in Rollup.
