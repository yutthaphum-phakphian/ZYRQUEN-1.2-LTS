...
if (!serverCode.includes('title: "Chamber 11 API Gateway Hit"')) {
    const importIndex = serverCode.indexOf('import ');
    serverCode = serverCode.slice(0, importIndex) + newData + "\n" + serverCode.slice(importIndex);
