    ...
    >
      ...
      <div className="space-y-2.5">
        {filteredList.map(item => (
          <div
            key={item.id}
            className="bg-slate-900/90 border-slate-800 hover:border-cyan-500/40 rounded-lg p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all duration-200 hover:shadow-lg"
          >
