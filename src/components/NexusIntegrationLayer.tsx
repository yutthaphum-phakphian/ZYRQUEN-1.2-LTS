...
export const NexusIntegrationLayer: React.FC<NexusIntegrationLayerProps> = ({
  ...
  return (
    <div id="nexus-integration-layer" className="w-full max-w-full overflow-hidden bg-[#070a12] border border-[#D4AF37]/40 rounded-xl p-3 sm:p-4 font-mono text-[#06B6D4] shadow-xl space-y-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap text-[11px] sm:text-xs">
          <button
            ...
            className={`px-2.5 sm:px-3 py-1.5 rounded font-bold transition-all flex items-center gap-1.5 shrink-0 ${
              currentView === 'nexus'
                ? 'bg-[#0a0f1e] border border-[#D4AF37] text-[#D4AF37]'
                : 'bg-[#0a0f1e] border border-slate-800 text-slate-300 hover:border-[#06B6D4]'
            }`}
          >
          ...
          <button
            ...
            className="px-2.5 py-1.5 bg-[#0a0f1e] border border-slate-700 text-slate-400 hover:text-slate-200 rounded text-[11px] sm:text-xs font-bold shrink-0"
          >
      ...
      {isExpanded && (
        <div className="pt-3 border-t border-slate-800 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-3 text-xs">
          <div className="p-2.5 sm:p-3 bg-[#0a0f1e] border border-slate-800 rounded space-y-1">
