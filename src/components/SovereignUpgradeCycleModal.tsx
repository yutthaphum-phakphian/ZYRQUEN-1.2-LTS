...
export const SovereignUpgradeCycleModal: React.FC<SovereignUpgradeCycleModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-black/80 backdrop-blur-md animate-in fade-in duration-200 font-mono">
      <div className="relative w-full max-w-2xl bg-[#0a0f1e] border-cyan-500/40 rounded-3xl p-5 sm:p-6 shadow-2xl space-y-5">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-cyan-950 text-cyan-300 border-cyan-500/40 text-[10px] font-bold">
                  CONSENSUS AUDIT
                </span>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5 font-bold">
                    {isDone ? (
                      ...
                      <div className="w-4 h-4 rounded-full border-zinc-600 shrink-0" />
                    )}
                  ...
                  <span
                    className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                      isDone
                        ...
                        : isCurrent
                        ? 'bg-cyan-900/60 text-cyan-300 border-cyan-400 animate-pulse'
        ...
        <div className="p-3 rounded-xl bg-black/80 border-white/10 text-xs font-mono text-cyan-300 flex items-center gap-2">
        ...
        {isCompleted && (
          <div className="p-3 rounded-2xl bg-emerald-950/60 border-emerald-500/50 text-xs text-emerald-200 flex items-center justify-between gap-3 animate-in fade-in">
            ...
            {!isCompleted ? (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 w-full sm:w-auto transition-all ${
                  isRunning
                    ? 'bg-cyan-950 text-cyan-300 border-cyan-500/40 cursor-not-allowed'
