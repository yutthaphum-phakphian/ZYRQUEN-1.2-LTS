...
export const SovereignRecoveryTimeline: React.FC = () => {
  ...
  return (
    <div
      ...
      className="bg-slate-950/90 border-emerald-500/30 rounded-xl p-5 text-emerald-400 font-mono shadow-2xl backdrop-blur-md transition-all duration-300 hover:border-emerald-500/50 my-4"
    >
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-emerald-500/20 pb-3 mb-4">
        <div className="flex items-center gap-2.5">
          <div className="p-2 bg-emerald-950/80 border-emerald-500/40 rounded-lg">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-emerald-600/30 to-cyan-600/30 hover:from-emerald-600/50 hover:to-cyan-600/50 border-emerald-400/50 rounded-lg text-xs text-white font-semibold shadow-sm transition-all cursor-pointer disabled:opacity-50"
          >
            {isRunningReplay ? (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mb-5 text-xs">
        <div className="bg-slate-900/80 border-emerald-500/20 rounded-lg p-2.5">
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-1.5">
                <div className="flex items-center gap-2">
                  <span className="px-2 py-0.5 rounded text-[11px] font-bold bg-emerald-950 text-emerald-300 border-emerald-500/40">
