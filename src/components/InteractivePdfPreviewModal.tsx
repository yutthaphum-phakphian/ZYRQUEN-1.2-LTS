...
export const InteractivePdfPreviewModal: React.FC<InteractivePdfPreviewModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-200" onClick={onClose}>
      <div className="bg-[#0b0d18] border-cyan-500/30 p-6 rounded-2xl shadow-[0_0_40px_rgba(6,182,212,0.3)] flex flex-col w-full max-w-3xl h-[80vh] relative" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-cyan-500/10 hover:bg-cyan-500/20 border-cyan-500/20 rounded-lg text-xs text-cyan-300 transition-colors">
        ...
        <div className="flex-1 bg-black/50 border-white/5 rounded-xl flex items-center justify-center relative overflow-hidden">
          <div className="text-center space-y-4 max-w-md p-6">
            <div className="w-16 h-16 bg-cyan-500/5 rounded-2xl border-cyan-500/10 flex items-center justify-center mx-auto mb-2 shadow-[inset_0_0_20px_rgba(6,182,212,0.05)]">
