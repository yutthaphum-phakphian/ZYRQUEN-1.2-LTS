...
export const MerkleVerifier: React.FC = () => {
  ...
  return (
    <section id="merkle-verifier-section" className="bg-[#0a0f1e] border border-[#17233f] p-4 mb-8">
      <div className="flex items-center justify-between border-b border-[#17233f] pb-3 mb-4">
        ...
        <span className="text-xs font-mono px-2 py-1 bg-[#070a12] border border-[#10B981] text-[#10B981]">
          Δ0.00% ZERO DRIFT
        </span>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4 font-mono text-xs">
        <div className="p-3 bg-[#070a12] border border-[#10B981]">
        ...
        <div className="p-3 bg-[#070a12] border border-[#EF4444]">
        ...
        <div className="p-3 bg-[#070a12] border border-[#D4AF37]">
      ...
      <div className="p-3 bg-[#070a12] border border-[#17233f] mb-4 text-xs font-mono">
      ...
      <form onSubmit={handleVerify} className="flex flex-col sm:flex-row gap-2">
        <input
          ...
          className="flex-1 bg-[#070a12] border border-[#17233f] px-3 py-2 text-xs font-mono text-[#F3F4F6] focus:border-[#D4AF37] focus:outline-none"
        />
        <button
          id="verify-seal-btn"
          type="submit"
