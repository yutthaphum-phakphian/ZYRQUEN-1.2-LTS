...
export const NcsaCiiComplianceCard: React.FC<NcsaCiiComplianceCardProps> = ({
  ...
  return (
    <div className="p-6 sm:p-7 rounded-[26px] bg-[#070a12] border border-amber-500/30 shadow-[0_10px_35px_-10px_rgba(245,158,11,0.15)] relative overflow-hidden font-mono space-y-6">
      {/* Background Glow */}
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onOpenChecklist && (
            <button
              ...
              className="px-3.5 py-2 rounded-xl text-xs font-bold bg-amber-500/15 hover:bg-amber-500/25 text-amber-200 border border-amber-500/40 transition-all flex items-center gap-1.5"
            >
      ...
      {/* Toast */}
      {toastMsg && (
        <div className="p-3 rounded-xl bg-amber-950/70 border border-amber-500/40 text-amber-200 text-xs flex items-center gap-2 animate-in fade-in">
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-[#0a0f1e] border border-white/10 space-y-3">
      ...
      <div className="p-4 rounded-2xl bg-[#0a0f1e] border border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {onOpenSearch && (
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-cyan-300 border border-cyan-500/30 text-xs font-bold transition-all flex items-center gap-1.5 shrink-0"
          >
