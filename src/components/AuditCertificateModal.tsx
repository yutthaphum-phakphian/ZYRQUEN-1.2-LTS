        ...
        <div className="stagger-2 px-4 sm:px-6 border-b border-white/8 bg-black/40 flex items-center gap-1.5 overflow-x-auto no-scrollbar">
          {[
            ...
            <button
              ...
              className={`py-2 px-2.5 text-[11px] sm:text-xs font-mono border-b-2 font-medium transition-all whitespace-nowrap cursor-pointer ${
                activeTab === tab.id
