    ...
    <div id="p0-frozen-core-guard-panel" className="p-6 rounded-[28px] bg-gradient-to-br from-[#070d18]/95 via-[#050912]/90 to-[#04060a] border-2 border-cyan-500/40 backdrop-blur-2xl space-y-6 shadow-2xl font-mono text-xs">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-cyan-500/20 pb-4">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="px-4 py-2 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 border-cyan-400/50 text-cyan-200 font-bold flex items-center gap-2 transition-all shadow-[0_0_15px_rgba(6,182,212,0.2)] disabled:opacity-50"
          >
      ...
      {activeTab === 'INVARIANTS' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          <div className="p-4 rounded-2xl bg-cyan-950/20 border-cyan-500/30 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 border-emerald-500/30 text-[10px] font-bold">
                100% INVIOLABLE
              </span>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 pt-1">
              <div className="p-3 rounded-xl bg-black/50 border-white/5 space-y-1">
              ...
              <div className="p-3 rounded-xl bg-black/50 border-white/5 space-y-1 md:col-span-2 lg:col-span-2">
      ...
      {activeTab === 'SEPARATION' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-2xl bg-cyan-950/30 border-cyan-500/40 space-y-2">
            ...
            <div className="p-4 rounded-2xl bg-amber-950/30 border-amber-500/40 space-y-2">
            ...
            <div className="p-4 rounded-2xl bg-rose-950/30 border-rose-500/40 space-y-2">
            ...
            <div className="p-4 rounded-2xl bg-purple-950/30 border-purple-500/40 space-y-2">
      ...
      {activeTab === 'QUARANTINE_5' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          <div className="p-3 rounded-xl bg-amber-950/20 border-amber-500/30 text-amber-200 text-xs flex items-center justify-between">
          ...
          <div className="space-y-2">
            {quarantineItems.map((item) => (
              <div
                key={item.sealNumber}
                className="p-3.5 rounded-xl bg-black/60 border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-3"
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2 font-bold">
                    ...
                    <span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-300 border-rose-500/30 text-[10px]">
                      {item.status}
                    </span>
                    <span className="px-2 py-0.5 rounded bg-zinc-800 text-zinc-400 border-zinc-700 text-[10px]">
                      {item.executionState}
                    </span>
                  </div>
