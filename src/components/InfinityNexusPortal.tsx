...
export const InfinityNexusPortal: React.FC = () => {
  return (
    <div className="p-8 bg-[#0b0d18] rounded-2xl border-cyan-500/20 shadow-[0_0_40px_rgba(6,182,212,0.1)] flex flex-col items-center justify-center min-h-[400px]">
      ...
      <div className="mt-8 flex gap-4">
        <div className="px-4 py-2 bg-white/5 rounded-lg border-white/10 text-xs text-emerald-400 font-mono">
          STATUS: OMNI-RESONANT
        </div>
        <div className="px-4 py-2 bg-white/5 rounded-lg border-white/10 text-xs text-cyan-400 font-mono">
          UPTIME: 99.9999%
        </div>
      </div>
    </div>
