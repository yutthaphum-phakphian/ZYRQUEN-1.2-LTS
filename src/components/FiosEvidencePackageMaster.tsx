  ...
  return (
    <div id="fios-evidence-package-master" className="p-6 rounded-[28px] bg-[#070c18] border-2 border-indigo-500/40 space-y-6 shadow-2xl font-mono text-zinc-200">
      ...
      <div className="p-4 rounded-2xl bg-black/60 border border-white/10 space-y-2.5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-[10px]">
          {[
            ...
            <div
              key={idx}
              className="p-2 rounded-lg bg-indigo-950/40 border border-indigo-500/30 text-indigo-200 flex items-center gap-1.5 font-bold"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-5 rounded-2xl bg-black/70 border border-indigo-500/30 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {currentManifest.dimensionCoverage.map((dim, i) => (
                <span
                  key={i}
                  className="px-2.5 py-1 rounded-lg bg-zinc-800 border border-white/10 text-zinc-200 text-[10px] font-bold"
                >
                  &bull; {dim}
                </span>
              ))}
