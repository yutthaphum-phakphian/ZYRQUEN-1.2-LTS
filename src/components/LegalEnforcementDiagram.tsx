...
export const DIAGRAM_NODES: DiagramNode[] = [
  ...
  },
  {
    ...
    technicalEnforcement: 'Executive Passport #EP-SOVEREIGN-01 (นายยุทธภูมิ ภักเพียร) physical biometric root-of-trust custody gate.',
  ...
  },
  {
    ...
    technicalEnforcement: 'Passport #EP-SOVEREIGN-01 (นายยุทธภูมิ ภักเพียร) perpetual biometric signature root.',
  ...
  },
  {
    ...
    subtext: 'การรับรองสิทธิ์โดยผู้ถืออำนาจสูงสุด นายยุทธภูมิ ภักเพียร',
