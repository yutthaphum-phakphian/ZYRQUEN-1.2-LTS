...
export function OperatorCopilot() {
  ...
  return (
    <div className="bg-[#0a0f1e] border border-[#06B6D4]/30 p-6 rounded-2xl text-white font-mono shadow-[0_0_30px_rgba(6,182,212,0.15)]">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs px-2.5 py-1 rounded-full bg-[#070a12] text-[#D4AF37] border border-[#D4AF37]/40 font-bold">
          OMEGA-1
        </span>
      </div>
