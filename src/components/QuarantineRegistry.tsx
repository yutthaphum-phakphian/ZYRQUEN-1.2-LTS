...
export const QuarantineRegistry: React.FC = () => {
  ...
  return (
    <div className="space-y-6 font-mono text-xs text-zinc-300">
      {/* Quarantine Banner */}
      <div className="p-5 rounded-[24px] bg-gradient-to-br from-amber-950/40 via-[#0a0d14]/90 to-black border-amber-500/40 backdrop-blur-xl flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
        <div className="flex items-center gap-3.5">
          <div className="w-11 h-11 rounded-2xl bg-amber-500/15 border-amber-500/40 text-amber-300 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(245,158,11,0.25)]">
            <ShieldAlert className="w-6 h-6" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-base font-bold text-white tracking-wide">QUARANTINE REGISTRY</h3>
              <span className="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border-amber-500/40 text-[10px] font-bold">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 border-rose-500/40 text-rose-200 font-bold transition-all text-xs flex items-center gap-1.5 shadow-[0_0_10px_rgba(244,63,94,0.2)]"
      ...
      {firewallTestOutput && (
        <div className="p-4 rounded-2xl bg-rose-950/60 border-rose-500/50 text-rose-200 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-in fade-in duration-200 shadow-2xl">
          ...
          <span className="px-2.5 py-1 rounded bg-rose-500/30 text-rose-100 border-rose-400/40 font-bold text-[10px] shrink-0 self-start sm:self-auto">
      ...
      {selectedItem && (
        <div className="p-5 rounded-[24px] bg-black/60 border-amber-500/30 backdrop-blur-xl space-y-4 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-3">
            ...
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-1 rounded bg-amber-500/20 text-amber-300 border-amber-500/40 text-[10px] font-bold">
                Classification: {selectedItem.classification}
              </span>
              <span className="px-2.5 py-1 rounded bg-rose-500/20 text-rose-300 border-rose-500/40 text-[10px] font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-[11px]">
            ...
            <div className="p-3.5 rounded-xl bg-black/50 border-white/5 space-y-1.5">
          ...
          <div className="p-3.5 rounded-xl bg-amber-950/20 border-amber-500/30 text-amber-200 text-[11px] space-y-1">
