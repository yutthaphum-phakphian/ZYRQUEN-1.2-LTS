    ...
    <div className="space-y-6 pb-20">
      ...
      {activeTab === 'dashboard' && (
        <div className="space-y-6">
          ...
          <div className="p-4 sm:p-6 rounded-2xl bg-black/30 backdrop-blur-md border border-[#D4AF37]/40 shadow-xl space-y-4">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
              <div className="flex items-center gap-3 w-full min-w-0">
                ...
                <div className="min-w-0">
                  <h2 className="text-base font-bold text-[#D4AF37] break-words whitespace-normal leading-snug">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs font-mono shrink-0">
                <span className="px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/40 font-bold text-[11px]">
                  Sync Health Score: 100%
                </span>
                <span className="px-2.5 py-1 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 text-[11px]">
                  Zero Drift Restored
                </span>
              </div>
            </div>
