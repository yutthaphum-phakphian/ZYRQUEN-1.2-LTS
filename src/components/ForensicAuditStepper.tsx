...
export const ForensicAuditStepper: React.FC<ForensicAuditStepperProps> = ({
  ...
  return (
    <div
      ...
      className={`rounded-2xl bg-[#090d1a]/95 border border-cyan-500/30 backdrop-blur-xl shadow-[0_12px_40px_rgba(0,0,0,0.6)] overflow-hidden transition-all duration-300 font-sans ${className}`}
    >
      {/* Top Header Bar */}
      <div className="px-4 py-3 bg-gradient-to-r from-[#070b16] via-[#091024] to-[#070b16] border-b border-cyan-500/20 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5">
          <div className="p-1.5 rounded-lg bg-cyan-500/15 border border-cyan-500/35 text-cyan-400">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            type="button"
            onClick={handleReset}
            className="p-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-zinc-300 hover:text-white border border-white/10 text-xs transition-colors cursor-pointer"
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-lg bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 border border-cyan-400/40 text-xs font-mono font-medium flex items-center gap-1.5 transition-colors cursor-pointer shadow-[0_0_10px_rgba(6,182,212,0.15)]"
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-zinc-400 hover:text-white border border-white/10 text-xs transition-colors cursor-pointer"
        ...
        <div className="p-4 space-y-4">
          ...
          {viewMode === 'stepper' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-8 p-4 rounded-xl bg-[#080c18] border border-cyan-500/25 space-y-3 relative overflow-hidden">
                {/* Background glow */}
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-cyan-500/15 hover:bg-cyan-500/25 text-cyan-300 border border-cyan-500/30 text-xs font-mono font-medium flex items-center gap-1 cursor-pointer transition-colors"
                ...
                {/* Merkle Hash & Actions */}
                <div className="p-2.5 rounded-lg bg-black/60 border border-cyan-500/20 flex flex-col sm:flex-row sm:items-center justify-between gap-2 font-mono text-xs">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="px-2 py-1 rounded bg-white/5 hover:bg-white/10 text-zinc-300 hover:text-white border border-white/10 text-[11px] flex items-center gap-1 cursor-pointer transition-colors"
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 border border-cyan-400/40 text-[11px] font-medium flex items-center gap-1 cursor-pointer transition-colors shadow-sm"
              ...
              <div className="lg:col-span-4 p-4 rounded-xl bg-[#080c18] border border-cyan-500/25 flex flex-col justify-between space-y-3 font-mono text-xs">
          ...
          {viewMode === 'matrix' && (
            <div className="space-y-3 font-mono text-xs">
              {/* Filter & Search Bar */}
              <div className="flex flex-wrap items-center justify-between gap-2.5 p-2 rounded-xl bg-black/40 border border-white/10">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-[#0b1020] border border-white/10 rounded px-2 py-1 text-xs text-zinc-300 focus:outline-none focus:border-cyan-500"
                  >
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded bg-white/5 hover:bg-white/10 border border-white/10 text-zinc-300 text-xs cursor-pointer transition-colors"
                  >
                        ...
                        >
                          ...
                          <td className="py-2 px-3 text-right">
                            <button
                              ...
                              className="p-1 rounded bg-white/5 hover:bg-white/10 text-cyan-300 border border-white/10 cursor-pointer transition-colors"
                              title="Download PDF"
                            >
