...
export const QuantumTelemetryBridge: React.FC = () => {
  ...
  return (
    <div id="quantum-telemetry-bridge" className="bg-[#070a12] text-[#06B6D4] p-6 rounded-xl border-[#D4AF37]/30 shadow-2xl font-mono">
      <div className="flex items-center justify-between mb-4 border-b border-[#0a0f1e] pb-3">
        ...
        <span className="text-xs bg-emerald-950/60 border-emerald-500 text-emerald-400 px-2.5 py-1 rounded font-bold">
          100% GREEN ACTIVE
        </span>
      </div>
      ...
      <ul className="space-y-1.5 font-mono text-xs">
        ...
        {telemetry.map((t, idx) => (
          <li key={idx} className="p-2 bg-[#0a0f1e] border-slate-800 rounded flex items-center justify-between">
