...
export const Room17MasterPanel: React.FC<Room17MasterPanelProps> = ({
  ...
  return (
    <div className="space-y-6 font-mono text-zinc-300">
      ...
      <div className="p-6 sm:p-8 rounded-[28px] bg-gradient-to-br from-amber-950/50 via-[#181105]/95 to-black border border-amber-500/50 backdrop-blur-xl relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/50 text-xs font-bold flex items-center gap-1.5 shadow-[0_0_15px_rgba(245,158,11,0.3)]">
          ...
          <div className="flex flex-wrap lg:flex-col items-center lg:items-end gap-3 shrink-0">
            <button
              ...
              className="px-5 py-3 rounded-xl bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-500 hover:to-yellow-500 text-black font-black text-xs flex items-center gap-2 shadow-xl shadow-amber-500/25 border border-amber-400/50 transition-all transform hover:-translate-y-0.5"
            >
      ...
      <div className="p-6 rounded-2xl bg-[#0d0f18] border border-amber-500/20 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5">
          {Array.from({ length: 18 }, (_, i) => {
            ...
            return (
              <div
                key={num}
                className="p-3 rounded-xl bg-black/40 border border-white/5 hover:border-amber-500/40 hover:bg-amber-950/20 transition-all text-left space-y-1 group"
              >
                <div className="flex items-center justify-between">
      ...
      <div className="p-6 rounded-2xl bg-[#0d0f18] border border-amber-500/20 space-y-3">
        <h3 className="text-base font-bold text-white flex items-center gap-2">
          <ShieldCheck className="w-4 h-4 text-emerald-400" />
          รากฐานสัจธรรมแห่งปฐมกาล (Genesis Merkle Root SSoT Anchor)
        </h3>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-4 rounded-xl bg-black/60 border border-white/10">
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-xs font-bold text-zinc-200 border border-white/10 flex items-center justify-center gap-1.5 shrink-0"
          >
