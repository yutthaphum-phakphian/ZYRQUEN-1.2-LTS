        ...
        {hasDrift ? (
          ...
          >
            ...
            <a
              ...
              title="เปิดลิงก์ GitHub Live Portal (https://yutthaphum-phakphian.github.io/ZYRQUEN-1.2-LTS/)"
            >
              ...
              <div className="p-3.5 rounded-xl bg-gradient-to-r from-cyan-950/40 via-sky-950/30 to-indigo-950/40 border border-cyan-500/30 space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  ...
                  >
                    ...
                    <span>Open GitHub Pages Portal (yutthaphum-phakphian.github.io/ZYRQUEN-1.2-LTS)</span>
                  </a>
                  <a
