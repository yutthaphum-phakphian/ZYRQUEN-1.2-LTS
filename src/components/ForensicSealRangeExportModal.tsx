    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/85 backdrop-blur-md p-4">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-[#0D0F1F] border border-white/10 space-y-4 font-mono">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-black/60 border border-white/15 text-white font-mono text-xs focus:border-cyan-400 focus:outline-none"
                />
              </div>
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-br from-[#0B0D1E] to-[#04050D] border border-cyan-500/30 space-y-3 font-mono text-xs">
            ...
            <div className="p-2.5 rounded-xl bg-black/50 border border-cyan-500/20 text-[10px] text-zinc-300 space-y-1">
            ...
            {exportCompleteName && (
              <div className="p-2.5 rounded-xl bg-emerald-500/15 border border-emerald-500/40 text-emerald-300 text-[11px] flex items-center gap-2 animate-in fade-in">
