...
export const CopilotSovereignAI: React.FC<CopilotSovereignAIProps> = ({
  ...
  return (
    <aside className={`fixed z-50 transition-all duration-300 ${
    ...
    } flex flex-col bg-slate-950/95 backdrop-blur-xl border-cyan-500/40 rounded-2xl shadow-2xl shadow-cyan-950/80 overflow-hidden`}>
      ...
      <div className="flex items-center justify-between px-3 py-2 bg-gradient-to-r from-cyan-950/90 via-slate-900 to-indigo-950/90 border-b border-cyan-800/40">
        <div className="flex items-center gap-2 min-w-0">
          <div className="p-1.5 rounded-lg bg-cyan-500/20 text-cyan-400 border-cyan-500/30 shrink-0">
            <Bot className="w-4 h-4" />
          </div>
          <div className="truncate">
            <div className="flex items-center gap-1.5">
              <span className="text-xs font-black text-white tracking-wide">COPILOT SOVEREIGN AI</span>
              <span className="px-1.5 py-0.2 text-[9px] font-bold rounded bg-cyan-500/20 text-cyan-300 border-cyan-400/40">v6.0 ULTRA</span>
              <span className="hidden sm:inline px-1.5 py-0.2 text-[9px] font-bold rounded bg-emerald-500/20 text-emerald-300 border-emerald-400/40">SOVEREIGN MESH</span>
            </div>
      ...
      <div className="flex items-center gap-1.5 px-2 py-1.5 overflow-x-auto no-scrollbar bg-slate-950 border-b border-slate-800/80 text-[10px]">
        <div className="px-2 py-0.5 rounded bg-slate-900 border-slate-800 text-slate-300 shrink-0 flex items-center gap-1">
          <RefreshCw className="w-2.5 h-2.5 text-cyan-400 animate-spin" /> Continuous...
        </div>
        <div className="px-2 py-0.5 rounded bg-slate-900 border-slate-800 text-slate-300 shrink-0">
          🛡️ 14,902 Seals
        </div>
        <div className="px-2 py-0.5 rounded bg-slate-900 border-slate-800 text-amber-300 shrink-0">
          🔮 HOLOGRAM M.
        </div>
        <div className="px-2 py-0.5 rounded bg-slate-900 border-slate-800 text-emerald-300 shrink-0">
          ⚡ Δ0.00% Zero
        </div>
        <div className="px-2 py-0.5 rounded bg-slate-900 border-slate-800 text-cyan-300 shrink-0">
          💻 DSL/VM Ready
        </div>
      </div>
      ...
      <div className="flex items-center justify-between px-2.5 py-1.5 bg-slate-900/50 text-[11px] border-b border-slate-800/60">
        ...
        <button 
          ...
          className="px-2 py-0.5 rounded bg-amber-950/60 border-amber-500/40 text-amber-300 text-[10px] font-semibold flex items-center gap-1 shrink-0 cursor-pointer"
        >
      ...
      <div className="flex-1 p-2.5 overflow-y-auto space-y-2 bg-slate-950 font-mono text-[11px] custom-scrollbar">
        {activeTab === 'dialogue' ? (
          <div className="p-2.5 rounded-xl bg-slate-900/90 border-cyan-500/30 space-y-2">
            ...
            <button 
              ...
              className="w-full py-1.5 px-3 rounded-lg bg-cyan-950/80 border-cyan-500/50 text-cyan-300 hover:bg-cyan-900 font-sans font-bold text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
            >
              <Download className="w-3.5 h-3.5" /> ดาวน์โหลด Signed Snapshot ทันที
            </button>
          </div>
        ) : (
          <div className="p-2.5 rounded-xl bg-slate-900/90 border-purple-500/30 space-y-2.5">
            <div className="flex items-center justify-between text-[10px] text-purple-400 border-b border-slate-800 pb-1 font-bold">
              ...
              <span className="px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 border-emerald-500/30">10/10 PASS</span>
            </div>

            <div className="grid grid-cols-2 gap-2 text-[10px]">
              <div className="p-2 rounded-lg bg-slate-950/80 border-slate-800">
            ...
            <div className="p-2 rounded-lg bg-slate-950/80 border-slate-800 space-y-1 text-[10px]">
        ...
        <div className="grid grid-cols-3 gap-1.5 text-[10px] font-sans">
          <button 
            ...
            className="p-1.5 rounded-lg bg-slate-900 border-slate-800 text-slate-300 hover:border-cyan-500/40 hover:text-cyan-300 truncate cursor-pointer"
          >
            (Pull SSoT)
          </button>
          <button 
            onClick={handleDownloadSnapshot}
            className="p-1.5 rounded-lg bg-slate-900 border-slate-800 text-slate-300 hover:border-cyan-500/40 hover:text-cyan-300 truncate flex items-center justify-center gap-1 cursor-pointer"
          >
      ...
      <div className="p-2 bg-slate-900 border-t border-slate-800">
        <div className="flex items-center gap-1.5 bg-slate-950 rounded-xl border-slate-800 px-2.5 py-1.5 focus-within:border-cyan-500/60 transition-colors">
          <input 
            type="text" 
            value={inputMsg}
          ...
          <button 
            onClick={handleSend}
            className="px-2.5 py-1 rounded-lg bg-cyan-500/20 text-cyan-300 border-cyan-500/40 hover:bg-cyan-500/30 font-bold text-xs flex items-center gap-1 shrink-0 transition-colors cursor-pointer"
          >
