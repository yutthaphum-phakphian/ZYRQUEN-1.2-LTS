                            ...
                            >
                              ...
                              <div className="flex items-center gap-1 shrink-0">
                                ...
                                <button
                                  ...
                                  className="opacity-0 group-hover:opacity-100 p-1 rounded-md text-zinc-400 hover:text-white hover:bg-white/10 transition-all text-[11px] font-mono flex items-center gap-1"
                                >
