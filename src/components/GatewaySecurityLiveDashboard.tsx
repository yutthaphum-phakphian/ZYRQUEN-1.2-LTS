...
export const GatewaySecurityLiveDashboard: React.FC = () => {
  ...
  return (
    <div className="bg-[#050814] border-cyan-500/30 rounded-xl p-6 text-cyan-400 font-mono shadow-2xl space-y-6">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-cyan-500/20">
        ...
        <div className="flex items-center gap-2">
          <span className="px-3 py-1 bg-cyan-950/80 border-cyan-500/40 rounded-full text-xs text-cyan-300">
            Genesis #849202 • SSoT Δ0.00%
          </span>
          <button
            onClick={triggerTamperSimulation}
            disabled={isSimulatingTamper}
            className="flex items-center gap-1.5 px-3 py-1 bg-rose-950/60 hover:bg-rose-900/80 border-rose-500/50 rounded-lg text-rose-300 text-xs font-bold transition-colors disabled:opacity-50"
          >
      ...
      {tamperFeedback && (
        <div className="p-3 bg-cyan-950/60 border-cyan-400/40 rounded-lg text-xs text-cyan-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-cyan-950/20 border-cyan-500/20 rounded-lg">
      ...
      <div className="p-4 bg-cyan-950/10 border-cyan-500/20 rounded-lg space-y-3">
        <h3 className="text-sm font-bold text-cyan-300">ETDA Electronic Transactions Act B.E. 2544 Gates</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div className="p-3 bg-[#080d20] border-cyan-500/30 rounded">
