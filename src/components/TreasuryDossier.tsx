...
export const TreasuryDossier: React.FC = () => {
  return (
    <section id="treasury-dossier-section" className="bg-[#0a0f1e] border-[#17233f] p-4 mb-8">
      <div className="flex items-center justify-between border-b border-[#17233f] pb-3 mb-4">
        ...
        <span className="text-xs font-mono px-2 py-1 bg-[#070a12] border-[#D4AF37] text-[#D4AF37]">
          VAULT SEALED
        </span>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4 font-mono text-xs">
        <div className="p-3 bg-[#070a12] border-[#17233f]">
