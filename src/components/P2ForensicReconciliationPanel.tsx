    ...
    <div id="p2-forensic-panel" className="p-6 rounded-[28px] bg-gradient-to-br from-[#0c0d1e]/95 via-[#080916]/90 to-[#04040a] border-2 border-indigo-500/40 backdrop-blur-2xl space-y-6 shadow-2xl font-mono text-xs text-zinc-300">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-indigo-500/20 pb-4">
        <div className="flex items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-indigo-500/15 border-indigo-500/40 text-indigo-300 flex items-center justify-center shrink-0 shadow-[0_0_20px_rgba(99,102,241,0.25)]">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-300 border-indigo-500/40 text-[10px] font-bold">
                PROVENANCE AUDIT
              </span>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-indigo-500/20 hover:bg-indigo-500/30 border-indigo-400/50 text-indigo-200 font-bold flex items-center gap-2 transition-all shadow-[0_0_15px_rgba(99,102,241,0.2)] disabled:opacity-50 text-[11px]"
          >
      ...
      {activeTab === 'MATRIX' && (
        <div className="space-y-4 animate-in fade-in duration-200">
              ...
              <tbody className="divide-y divide-white/5">
                {records.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <span className="px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 border-amber-500/30 text-[9px] font-bold">
                        {item.classification}
                      </span>
                    </td>
                    <td className="p-3">
                      <span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-300 border-rose-500/30 text-[9px] font-bold">
                    ...
                    <td className="p-3 text-right">
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-200 border-indigo-500/40 text-[10px] font-bold transition-all"
                      >
                        Re-Verify
                      </button>
                    </td>
          ...
          {selectedRecord && (
            <div className="p-4 rounded-2xl bg-black/60 border-indigo-500/30 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-[11px]">
                <div className="space-y-1 bg-black/40 p-3 rounded-xl border-white/5">
                  <div>
          ...
          <div className="p-4 rounded-2xl bg-black/60 border-white/10 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-2">
              {[
                ...
                <div key={step.step} className="p-3 rounded-xl bg-black/40 border-white/5 space-y-1">
      ...
      {activeTab === 'GENESIS_ANCHOR' && (
        <div className="space-y-4 animate-in fade-in duration-200">
          <div className="p-4 rounded-2xl bg-black/60 border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-xl bg-rose-950/20 border-rose-500/30 text-rose-200 text-[11px] space-y-1">
            ...
            {tests.map((test) => (
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-0.5 rounded bg-indigo-500/20 text-indigo-300 border-indigo-500/30 text-[10px] font-bold">
                      [{test.id}]
                    </span>
