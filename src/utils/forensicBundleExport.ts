 ...
 * Follows Clean Architecture standards by consuming SSoT configuration from @/config.
 */
...
Block Height: ${SOVEREIGN_CONFIG.genesisAnchor.blockHeight}
Timestamp: ${new Date().toISOString()}
Merkle Root: ${SOVEREIGN_CONFIG.genesisAnchor.merkleRoot}
Clearance: ${SOVEREIGN_CONFIG.sovereignPrincipal.clearance}
...
`;
    ...
    anchor.href = url;
    anchor.download = `ZYRQ-ARCHIVE-${SOVEREIGN_CONFIG.genesisAnchor.blockHeight}.zip`;
    anchor.click();
